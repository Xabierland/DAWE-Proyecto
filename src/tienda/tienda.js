...
export const listaProductos = [
    ...
    new Libro("El nombre del viento", 20, "Atípica, profunda y sincera, El nombre del viento es una novela de aventuras, de historias dentro de otras historias, de misterio, de amistad, de amor, de magia y de superación.", "Patrick Rothfuss", 5558675848, 800, '/img/productos/ElNombreDelViento.jpg'),
    
    // Libros Electrónicos
    new Ebook("Dungeon Crawler Carl", 5, "The apocalypse will be televised! You know what's worse than breaking up with your girlfriend? Being stuck with her prize-winning show cat.", "Matt Dinniman", 2, 400, 300, '/img/productos/DungeonCrawlerCarl.jpg'),
    new Ebook("El camino de los reyes", 15, "El camino de los reyes es el primer volumen de «El Archivo de las Tormentas», el resultado de más de una década de construcción y escritura de universos, convertido en una obra maestra de la fantasía contemporánea en diez volúmenes.", "Brandon Sanderson", 6, 1200, 500, '/img/productos/ElCaminoDeLosReyes.jpg'),
    new Ebook("Palabras radiantes", 15, "Hace seis años, un asesino mató al rey Alethi, y ahora está asesinando a los gobernantes de todo Roshar; entre sus principales objetivos es Dalinar.", "Brandon Sanderson", 7, 1300, 550, '/img/productos/PalabrasRadiantes.jpg'),
    ...
    // Marcapáginas
    new Marcapaginas("Marcapáginas de cartón", 2, "Marca las páginas con estilo", "Cartón", '/img/productos/MarcapaginasDeCarton.jpg'),
    ...
    // Fundas
    new Funda("Funda Kobo Clara X5", 20, "Protege tu Kobo Clara", "Wolframio", '/img/productos/FundaKoboClara.jpg'),
    new Funda("Funda Kindle Paperwhite", 20, "Protege tu Kindle", "Plastico duro", '/img/productos/FundaKindlePaperwhite.jpg'),
